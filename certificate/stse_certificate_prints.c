...
void stse_certificate_print_parsed_cert(stse_certificate_t *stse_certificate) {
    ...
    printf("\n\r\t Cert PubKey (%s): ", *stse_certificate->p_pub_key_point_representation_id == 0x04 ? "Uncompressed" : "Compressed");
    print_buffer("\n\r\t\t X: ", stse_certificate->PubKey.p_x, stse_certificate->PubKey.fsize);
    if (*stse_certificate->p_pub_key_point_representation_id == 0x04) {
