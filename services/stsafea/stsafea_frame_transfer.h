 ...
 */
stse_return_code_t stsafea_frame_transmit(stse_handler_t *p_stse,
 ...
 * \return 			\ref STSE_OK on success ; \ref stse_return_code_t error code otherwise
 */
stse_return_code_t stsafea_frame_receive(stse_handler_t *p_stse,
                                        stse_frame_t *p_frame);
 ...
 * \return 			\ref STSE_OK on success ; \ref stse_return_code_t error code otherwise
 */
stse_return_code_t stsafea_frame_transfer(stse_handler_t *p_stse,
                                         stse_frame_t *p_cmd_frame,
                                         stse_frame_t *p_rsp_frame);
