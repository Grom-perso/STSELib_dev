 ...
 * \param[in]	p_encrypted_authentication_tag	Buffer containing the encrypted authentication tag
 ...
 * \param[out]	p_verification_result		Verification result flag (0 : fail ; 1: pass)
 * \param[out]	p_plaintext_message			Buffer to store the decrypted message
 * \return \ref STSE_OK on success ; \ref stse_return_code_t error code otherwise
 */
